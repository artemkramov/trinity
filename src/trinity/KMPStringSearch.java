 ...
 * Table. The table is created in O(n) where n is the length of the word. After the pre-processing, the actual search can
 * be performed in O(k) where k is the size of the sentence.
 */
public class KMPStringSearch {
    
    /**
	 * Searches for all occurrences of the word in the sentence. Runs in O(n+k) where n is the word length and k is the
	 * sentence length.
	 * 
